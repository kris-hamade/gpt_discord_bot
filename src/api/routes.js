 ...
 * /api/clearUploadData:
 *   delete:
 *     summary: Clear uploaded data
 *     description: Deletes all files from the upload directory.
 *     security:
 *       - ApiKeyAuth: []
 *     responses:
 *       200:
 *         description: Success message indicating all uploaded files have been deleted.
 *       500:
 *         description: Error message in case of a server error.
 */
